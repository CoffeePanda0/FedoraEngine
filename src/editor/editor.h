...
extern SDL_Texture **editor_textures; // The texture atlas (stores 10)
extern char **editor_texturepaths;
extern SDL_Texture **editor_backgrounds; // The background atlas (stores 10)
extern char **editor_backgroundpaths;
