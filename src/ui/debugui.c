...
{
    update_label = FE_UI_CreateLabel(PresentGame->font, "Update: ", rel_w(20), vec(0, 0), COLOR_BLACK);
    FE_UI_AddElement(FE_UI_LABEL, update_label);
    update_label->showbackground = true;

    event_label = FE_UI_CreateLabel(PresentGame->font, "Event: ", rel_w(20), vec(0, 25), COLOR_BLACK);
    FE_UI_AddElement(FE_UI_LABEL, event_label);
    event_label->showbackground = true;

    render_label = FE_UI_CreateLabel(PresentGame->font, "Render: ", rel_w(20), vec(0, 50), COLOR_BLACK);
    FE_UI_AddElement(FE_UI_LABEL, render_label);
    render_label->showbackground = true;

    fps_label = FE_UI_CreateLabel(PresentGame->font, "FPS: ", rel_w(20), vec(0, 75), COLOR_BLACK);
    FE_UI_AddElement(FE_UI_LABEL, fps_label);
    fps_label->showbackground = true;

    coord_label = FE_UI_CreateLabel(PresentGame->font, "X: Y:", rel_w(20), vec(0, 100), COLOR_BLACK);
    FE_UI_AddElement(FE_UI_LABEL, coord_label);
    coord_label->showbackground = true;

    velocity_label = FE_UI_CreateLabel(PresentGame->font, "Velocity: ", rel_w(20), vec(0, 125), COLOR_BLACK);
