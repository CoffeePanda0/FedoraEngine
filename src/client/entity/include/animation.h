...
typedef struct FE_Animation {
    ...
    uint16_t frame_width; // The width of each frame
    uint16_t frame_height; // The height of each frame
...
*/
FE_Animation *FE_Animation_Create(char *spritesheet_name, Uint8 frame_count, uint16_t frame_width, uint16_t frame_height, uint16_t frame_duration, bool active);
